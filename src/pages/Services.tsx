...
export const Services = () => {
    return (
        <div className="w-full flex" id="services">
            <div className="relative bg-[#343a40] flex items-center flex-col w-full text-white lg:h-[100vh] justify-center">
                <div className="relative mb-5 py-7" >
                    <h1 className="font-bold text-8xl text-[#4a4a4a]" >SERVICES</h1>
                    <h3 className="left-16 absolute top-12 text-4xl">What I Do</h3>
                </div>
                <div>
                    <div className="flex gap-12 w-[80vw] md:w-full md:px-24 py-7 text-[15px] flex-col lg:flex-row">
                        <BoxWrapper>
...
const BoxWrapper: FC<SidebarProps> = ({ children }) => {
    return (
        <div className="flex gap-3 flex-col items-center lg:w-1/3 justify-center border p-7 rounded-3xl flex-wrap lg:h-[42vh] lg:text-lg">
            {children}
        </div>
    );
};
