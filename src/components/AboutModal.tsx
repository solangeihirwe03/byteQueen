...
import { IoLocationSharp, IoCall, IoClose } from "react-icons/io5";
...
const AboutModal:React.FC<AboutProps>= ({confirm}) => {
    ...
    return (
        <div className="w-full flex px-12 relative h-screen py-2">
            <button className="absolute right-20 top-10" onClick={confirm}>
                <IoClose fontSize={30}/>
            </button>
            ...
            <div className="w-2/3 p-16 overflow-y-auto ml-[28rem] flex-1 no-scrollbar">
                ...
                <div>
                    ...
                    <div className="border-l-2 border-[#1E1E1E] relative h-60">
                        <div className="absolute left-[-13px] top-10 w-6 h-6 rounded-full bg-[#F4A169]"></div>
                        <div className="p-8 ml-16 flex gap-40 items-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-extralight">Bachelor degree</p>
                            </div>
                        </div>
